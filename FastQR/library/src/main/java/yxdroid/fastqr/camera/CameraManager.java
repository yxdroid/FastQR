...
import yxdroid.fastqr.camera.open.OpenCameraInterface;
    ...
    */
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            Log.d(TAG, "screenResolution.x " + screenResolution.x
                    + " screenResolution.y " + screenResolution.y + " width " + width + " height " + height);
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height) / 2;

            /*if (laserFrameTopMargin == 0)
                laserFrameTopMargin = topOffset - getStatusBarHeight();
            else {
                laserFrameTopMargin += getStatusBarHeight();
            }*/
